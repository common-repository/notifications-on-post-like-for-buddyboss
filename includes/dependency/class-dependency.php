...
abstract class Notifications_On_Post_Like_For_BuddyBoss_Plugins_Dependency {

    function __construct() {

        add_filter( 'notifications-on-post-like-for-buddyboss-load', array( $this, 'boilerplate_load' ) );
    ...
    public function get_plugin_name() {
        ...
        $plugin_data = get_plugin_data( NOTIFICATIONS_ON_POST_LIKE_FOR_BUDDYBOSS_FILES );
